...
function BillingApp() {
    const [customers, setCustomers] = useState(customersNew);
    ...
    const createBill = () => {
      ...
      // Sync the updated customer balance
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    setSelectedCustomer(customers.find((c) => c.id === parseInt(value)))
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    addItem(items.find((i) => i.id === parseInt(value)))
                  }
                >
                  <SelectTrigger>
              ...
              {selectedItems.map((item, index) => (
                <BillItem
                  ...
                  onQuantityChange={(quantity) =>
                    updateItemQuantity(index, parseInt(quantity))
                  }

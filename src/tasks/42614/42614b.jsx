...
// import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Select, SelectItem } from "@/components/ui";
...
//               <Select value={selectedCustomer.id} onValueChange={(value) => setSelectedCustomer(customers.find(c => c.id === parseInt(value)))}>
